  ...
  return (
    ...
    >
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <p className="mt-4 font-light text-muted-foreground">Vendas em tempo real, relatórios, estornos e antecipação de recebíveis. Taxa única e transparente: <span className="text-foreground font-semibold">15%</span> por transação aprovada — sem mensalidade, sem setup.</p>
      </div>
